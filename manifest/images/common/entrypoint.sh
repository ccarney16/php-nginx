...
function start_server {
    ...
    chmod 770 /var/lib/www-user/tmp/ /var/lib/www-user/tmp/php/{session,opcache,wsdlcache} 
    ...
    printf "[init] NGINX Version: $(nginx -v 2>&1 | cut -d ' ' -f 3)\n"
...
# Set ownership of stdout/stderr and run as www-user if running as root
